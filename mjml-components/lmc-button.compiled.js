...
var LmcButton = (_temp = _class = function (_BodyComponent) {
  ...
  function LmcButton() {
    (0, _classCallCheck3.default)(this, LmcButton);
    return (0, _possibleConstructorReturn3.default)(this, (LmcButton.__proto__ || (0, _getPrototypeOf2.default)(LmcButton)).apply(this, arguments));
  }

  (0, _createClass3.default)(LmcButton, [{
    key: 'getStyles',
